...
1. length function only works for numbers that do not have a leading zero

2. square_digit function "seemingly" works for all reasonable numbers, but there were
...
1. I'd like the square vector function to modify vectors in place to save space.
...
2. I wonder if there is a way to extend this to arrays, and not just std::vectors.
